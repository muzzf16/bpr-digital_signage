-- PostgreSQL Migration for BPR Digital Signage System
-- This is the original schema that should be used in production
...
CREATE INDEX idx_promos_published ON promos(published, start_at, end_at);
CREATE INDEX idx_products_published ON products(published, effective_date, display_until);
